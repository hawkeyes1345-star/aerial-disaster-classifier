summary = r"""# AI-Powered Disaster Classification from Aerial Imagery
...
with open(r"C:\flood_project\RESULTS_SUMMARY.md", "w", encoding="utf-8") as f:
    f.write(summary)

print("Saved RESULTS_SUMMARY.md to C:\\flood_project")